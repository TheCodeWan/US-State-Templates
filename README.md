...
**Good state tag:** `full-maps-2026-06-29`

### Recovery commands
```bash
git show full-maps-2026-06-29:"Maps of the entire US/examples/concealed-carry-sd/us-states-concealed-carry-sd.html" > full-concealed.html
# Same for blank and labeled
```

See git history or GitHub file history for previous good commits.
